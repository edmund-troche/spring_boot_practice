...
public class ControllerLoggingAspect {
     ...
     */
    @Around(
            "org.troche.spring.application.exercise.aspect.CommonJoinPoints.v1ControllersMethodTracing()")
    public Object aroundControllerMethodAdvice(final ProceedingJoinPoint joinPoint)
            throws Throwable {
